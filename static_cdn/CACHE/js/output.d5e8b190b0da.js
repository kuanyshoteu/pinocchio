;$(document).ready(function(){$('#search-input').on('input',function(e){id=$(this).attr('id')
text=$(this).val()
url=$(this).attr('url')
...
if(image_url==''){image_url="/static/images/nophoto.png"}
...
$("body").click(function(e){$('.search-bar').hide();});