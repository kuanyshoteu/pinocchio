    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='school_boards', to='schools.School')),
            ],
        ),
        migrations.CreateModel(
            name='Card',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_type', models.CharField(default='', max_length=255)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='school_docs', to='schools.School')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ffile', models.ManyToManyField(related_name='ffile', to='todolist.Document')),
            ],
            options={
                'ordering': ['timestamp'],
            },
